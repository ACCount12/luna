...
/obj/submachine/seedmutator
	...
	attack_hand(var/mob/user as mob)
		...
		if (src.screen == 1)
			...
			dat += "<B>Currently Viewing:</B> Seed Slot [src.current]<BR>"
			dat +="<B>Seed:</B> [currentseed]<BR>"
			dat +="<B>Seed Radiation Level:</B> [currentseed:radiation]<BR><BR>"
			dat +="<B>Maturation Gene:</B> [DNA.growtime] <A href='?src=\ref[src];ops=1'>Irradiate<BR>"
			dat +="<B>Production Gene:</B> [DNA.harvtime] <A href='?src=\ref[src];ops=2'>Irradiate<BR>"
			dat +="<B>Lifespan Gene:</B> [DNA.harvests] <A href='?src=\ref[src];ops=3'>Irradiate<BR>"
			dat +="<B>Yield Gene:</B> [DNA.cropsize] <A href='?src=\ref[src];ops=4'>Irradiate<BR>"
			dat +="<B>Potency Gene:</B> [DNA.potency] <A href='?src=\ref[src];ops=5'>Irradiate<BR>"
			dat +="<B>Endurance Gene:</B> [DNA.endurance] <A href='?src=\ref[src];ops=6'>Irradiate<BR><BR>"
			dat +="<HR><BR>"
			dat +="<A href='?src=\ref[src];ops=7'>Eject Seeds<BR>"
			dat +="<A href='?src=\ref[src];ops=8'>Change Slot<BR>"
			dat +="<A href='?src=\ref[src];ops=9'>Seed Splicing<BR>"
			...
			if (src.seed1 && src.seed2)
				...
				dat += {"<u><B>Seed #1:</B> [src.seed1]</u><BR>
				...
				dat += {"<B>Seed Splicing requires two seeds to be inserted.</B><BR>
