...
/obj/effect/shielding/shield/CanPass(atom/movable/mover, turf/source, height=1.5, air_group = 0)
	if (density)
...
/obj/effect/shielding/shield/ex_act(strength)
	if (strength <= 0)
		strength = -strength
