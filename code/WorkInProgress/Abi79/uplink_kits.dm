...
/obj/item/weapon/storage/box/syndie_kit/imp_control
	name = "Mind Control Implant (with injectors)"

/obj/item/weapon/storage/box/syndie_kit/imp_control/New()
	var/obj/item/weapon/implanter/O = new /obj/item/weapon/implanter(src)
	O.name = "master"
...
/obj/item/weapon/storage/box/syndie_kit/imp_alien
	name = "Alien Embryo (with injector) - Not fully tested on humans!"

/obj/item/weapon/storage/box/syndie_kit/imp_alien/New()
	var/obj/item/weapon/implanter/O = new /obj/item/weapon/implanter(src)
...
/obj/item/weapon/storage/box/syndie_kit/imp_vfac
	name = "Viral Factory Implant (with injector)"

/obj/item/weapon/storage/box/syndie_kit/imp_vfac/New()
	var/obj/item/weapon/implanter/O = new /obj/item/weapon/implanter(src)
