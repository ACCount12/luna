...
/obj/machinery/power/port_gen/process()
	if(active && HasFuel() && !crit_fail && anchored && GetPowernet())
		AddPower(power_gen * power_output)
		UseFuel()
		src.updateDialog()
...
/obj/machinery/power/port_gen/pacman/HasFuel()
	if(sheets >= 1 / (time_per_sheet * consumption / power_output) - sheet_left)
		return 1
	return 0
...
//				disconnect_from_network()
			...
			var/obj/structure/frame/machine/new_frame = new /obj/structure/frame/machine(src.loc)
...
/obj/machinery/power/port_gen/pacman/interact(mob/user)
	...
	dat += text("Power current: [(GetPowernet() ? "[avail]" : "Unconnected")]<br>")
