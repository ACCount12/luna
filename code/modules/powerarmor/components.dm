/obj/item/weapon/powerarmorcomponent
...
/obj/item/weapon/powerarmorcomponent/power
...
/obj/item/weapon/powerarmorcomponent/reactive
...
/obj/item/weapon/powerarmorcomponent/servos
...
/obj/item/weapon/powerarmorcomponent/atmoseal
	...
	toggle(sudden = 0)
		switch(parent.active)
			if(1)
				...
				parent.protective_temperature -= 3000
				if(parent.helmrequired && parent.helm)
					...
					parent.helm.protective_temperature -= 3000
				...
				if(parent.glovesrequired)
					...
					parent.gloves.protective_temperature -= 3000
				if(parent.shoesrequired)
					...
					parent.shoes.protective_temperature -= 3000
				sealed = 0
