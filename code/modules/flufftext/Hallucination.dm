			...
			if(66 to 70)
				...
				if(!halbody)
					...
					if(possible_points.len)
						...
						switch(rand(1,4))
							if(1,2) // Ling theme
								halbody = image('icons/mob/human.dmi',target,pick("husk_l", "husk_s"),TURF_LAYER)
							if(3,4) // Xeno theme
								halbody = image('icons/mob/alien.dmi',target, pick("egg", "facehugger", "queen_s"),TURF_LAYER)
	//						if(5)
...
var/list/non_fakeattack_weapons = list(/obj/item/weapon/gun/projectile/revolver, /obj/item/ammo_magazine/box/a357,\
	/obj/item/weapon/gun/energy/crossbow, /obj/item/weapon/melee/energy/sword,\
	/*obj/item/weapon/storage/box/syndicate,*/ /obj/item/weapon/storage/box/grenades/emp,\
	...
	/obj/item/device/hand_tele, /obj/item/weapon/rcd, /obj/item/weapon/tank/jetpack,\
	/obj/item/clothing/under/rank/captain, /*obj/item/device/aicard,*/\
	/obj/item/clothing/shoes/magnetic, /*obj/item/blueprints,*/ /obj/item/weapon/disk/nuclear,\
