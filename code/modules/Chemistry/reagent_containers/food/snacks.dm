...
/obj/item/weapon/pizzabox/update_icon()
	overlays = list()
	...
	if(open && pizza)
		...
		var/obj/item/weapon/pizzabox/topbox = boxes[boxes.len]
...
/obj/item/weapon/pizzabox/attack_hand(mob/user)
	if(open && pizza)
	...
	if(boxes.len > 0)
		...
		var/obj/item/weapon/pizzabox/box = boxes[boxes.len]
		boxes -= box
...
/obj/item/weapon/pizzabox/attack_self(mob/user)
	if(boxes.len > 0 )
		return
...
/obj/item/weapon/pizzabox/attackby(obj/item/I, mob/user)
	if( istype(I, /obj/item/weapon/pizzabox/) )
		var/obj/item/weapon/pizzabox/box = I

		if(!box.open && !open)
			// Make a list of all boxes to be added
			var/list/boxestoadd = list()
			boxestoadd += box
			for(var/obj/item/weapon/pizzabox/i in box.boxes)
				boxestoadd += i
	...
	if(istype(I, /obj/item/weapon/pen/))
		...
		var/obj/item/weapon/pizzabox/boxtotagto = src
		if(boxes.len > 0)
