/mob/living/carbon/slime
	...
	var/cores = 1 // the number of /obj/item/weapon/slime_extract's the slime has left inside
	...
	var/coretype = /obj/item/weapon/slime_extract/grey
...
mob/living/carbon/slime/co2overloadtime = null
mob/living/carbon/slime/temperature_resistance = T0C+75
...
/mob/living/carbon/slime/updatehealth()
	if(status_flags & GODMODE)
		...
		if(istype(src, /mob/living/carbon/slime/adult))
			health = 200 - (getOxyLoss() + getToxLoss() + getFireLoss() + getBruteLoss())
		else
...
/obj/item/weapon/slime_extract/New()
		..()
		var/datum/reagents/R = new/datum/reagents(100)
		reagents = R
		R.my_atom = src

/obj/item/weapon/slime_extract/grey
	name = "grey slime extract"
	icon_state = "grey slime extract"

/obj/item/weapon/slime_extract/gold
	name = "gold slime extract"
	icon_state = "gold slime extract"

/obj/item/weapon/slime_extract/silver
	name = "silver slime extract"
	icon_state = "silver slime extract"

/obj/item/weapon/slime_extract/metal
	name = "metal slime extract"
	icon_state = "metal slime extract"

/obj/item/weapon/slime_extract/purple
	name = "purple slime extract"
	icon_state = "purple slime extract"

/obj/item/weapon/slime_extract/darkpurple
	name = "dark purple slime extract"
	icon_state = "dark purple slime extract"

/obj/item/weapon/slime_extract/orange
	name = "orange slime extract"
	icon_state = "orange slime extract"

/obj/item/weapon/slime_extract/yellow
	name = "yellow slime extract"
	icon_state = "yellow slime extract"

/obj/item/weapon/slime_extract/red
	name = "red slime extract"
	icon_state = "red slime extract"

/obj/item/weapon/slime_extract/blue
	name = "blue slime extract"
	icon_state = "blue slime extract"

/obj/item/weapon/slime_extract/darkblue
	name = "dark blue slime extract"
	icon_state = "dark blue slime extract"

/obj/item/weapon/slime_extract/pink
	name = "pink slime extract"
	icon_state = "pink slime extract"

/obj/item/weapon/slime_extract/green
	name = "green slime extract"
	icon_state = "green slime extract"

/obj/item/weapon/slime_extract/lightpink
	name = "light pink slime extract"
	icon_state = "light pink slime extract"

/obj/item/weapon/slime_extract/black
	name = "black slime extract"
	icon_state = "black slime extract"

/obj/item/weapon/slime_extract/oil
	name = "oil slime extract"
	icon_state = "oil slime extract"

/obj/item/weapon/slime_extract/adamantine
	name = "adamantine slime extract"
	icon_state = "adamantine slime extract"

/obj/item/weapon/slime_extract/bluespace
	name = "bluespace slime extract"
	icon_state = "bluespace slime extract"

/obj/item/weapon/slime_extract/pyrite
	name = "pyrite slime extract"
	icon_state = "pyrite slime extract"

/obj/item/weapon/slime_extract/cerulean
	name = "cerulean slime extract"
	icon_state = "cerulean slime extract"

/obj/item/weapon/slime_extract/sepia
