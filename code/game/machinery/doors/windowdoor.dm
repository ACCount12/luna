/obj/machinery/door/window
	...
	icon_state = "left"
	var/base_state = "left"
	var/health = 150 //If you change this, consiter changing /door/window/brigdoor/ health at the bottom of this .dm file
	visible = 0.0
	use_power = 0
	flags = ON_BORDER
	opacity = 0
	var/obj/item/weapon/circuitboard/airlock_electronics/electronics = null
...
/*		if(istype(I, /obj/item/weapon/melee/energy/blade))
	...
	if(istype(I, /obj/item/weapon) && !istype(I, /obj/item/weapon/card))
		var/aforce = I.force
