/obj/item/weapon/cartridge
	...
	security
		...
		New()
			..()
			spawn(5)
				radio = new /obj/item/device/radio/integrated/beepsky(src)
	...
	signal
		...
		New()
			..()
			spawn(5)
				radio = new /obj/item/device/radio/integrated/signal(src)
	...
	quartermaster
		...
		New()
			..()
			spawn(5)
				radio = new /obj/item/device/radio/integrated/mule(src)
...
<a href='byond://?src=\ref[src];choice=Signal Code;scode=5'>+</a><br>"}
			...
			if (46) //beepsky control
				var/obj/item/device/radio/integrated/beepsky/SC = radio
				if(!SC)
			...
			if (48) //mulebot control
				var/obj/item/device/radio/integrated/mule/QC = radio
				if(!QC)
					menu = "Interlink Error - Please reinsert cartridge."
					return
