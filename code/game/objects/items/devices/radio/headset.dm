...
/obj/item/device/radio/headset/headset_rob
	...
	desc = "Made specifically for the roboticists who cannot decide between departments. To access the engineering channel, use :e. For research, use :n. For medical, use :m."
...
/obj/item/device/radio/headset/heads/captain
	...
	desc = "The headset of the boss. Channels are as follows: :c - command, :s - security, :e - engineering, :q - supply, :m - medical, :n - science."
	icon_state = "com_headset"
...
/obj/item/device/radio/headset/heads/hop
	...
	desc = "The headset of the guy who will one day be captain. Channels are as follows: :q - supply, :c - command, :s - security"
	icon_state = "com_headset"
	keyslot2 = new /obj/item/device/encryptionkey/heads/hop

/obj/item/device/radio/headset/headset_mine
	name = "mining radio headset"
	desc = "Headset used by miners. To access the supply channel, use :q."
...
/obj/item/device/radio/headset/headset_cargo
	...
	desc = "A headset used by the man who control your toiletpaper supply and his slaves. To access the supply channel, use :q."
...
/obj/item/device/radio/headset/proc/recalculateChannels()
	...
	if(keyslot1)
		...
		if(keyslot1.translate_binary)	src.translate_binary = 1
		if(keyslot1.translate_hive)		src.translate_hive = 1
		if(keyslot1.syndie)				src.syndie = 1
	...
	if(keyslot2)
		...
		if(keyslot2.translate_binary)	src.translate_binary = 1
		if(keyslot2.translate_hive)		src.translate_hive = 1
