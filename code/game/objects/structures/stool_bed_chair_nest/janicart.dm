...
/obj/structure/stool/bed/chair/janicart
	...
	var/obj/item/weapon/satchel/trash/mybag	= null
...
/obj/structure/stool/bed/chair/janicart/attackby(obj/item/I, mob/user)
	...
	else if(istype(I, /obj/item/weapon/satchel/trash))
...
/obj/structure/stool/bed/chair/janicart/snow
	icon_state = "snow"


/obj/structure/stool/bed/chair/janicart/snow/update_mob()
	if(buckled_mob)
		buckled_mob.dir = dir
	return